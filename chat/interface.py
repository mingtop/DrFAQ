...
class ChatInterface:
    def __init__(self):
        ...
        # self.faq = FAQ("match/faq_covidbert.csv")
        self.faq = FAQ("match/demo.csv")
        print('init FAQ')
...
#        self.search = Search("search/SearchCorpus.txt")
    ...
    def reply(self, message):
        ...
        answer = self.faq.ask_faq(message, threshold=0.5)  # change to 0.9 for large model
        if answer:
            print("Answer:", answer)
            return answer+'For more related COVID information, please visit our MOH websit:https://www.moh.gov.sg'
        else:
            return "Out of our knowledge database"
